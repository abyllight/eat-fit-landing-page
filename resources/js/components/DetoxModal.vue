            ...
            <div class="bg-white px-3 pt-8 pb-4 md:px-6">
                ...
                <div>
                    <div class="flex items-center justify-between">
                        ...
                        <div>
                            <p class="font-semibold -mb-2" :class="[count > 2 ? 'text-gray-600 oldPrice text-sm' : 'text-brand-green']"> {{ count * data.price }}₸</p>
                            <p v-show="count > 2" class="font-bold text-brand-green text-xl"> {{ total }}₸</p>
                        </div>
